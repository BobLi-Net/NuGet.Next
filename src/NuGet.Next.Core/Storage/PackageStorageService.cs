...
public class PackageStorageService : IPackageStorageService
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        if (result == StoragePutResult.Conflict)
        {
            ...
            throw new InvalidOperationException(
                $"Failed to store package {lowercasedId} {lowercasedNormalizedVersion} due to conflict");
        }
        ...
        if (result == StoragePutResult.Conflict)
        {
            ...
            throw new InvalidOperationException(
                $"Failed to store package {lowercasedId} {lowercasedNormalizedVersion} nuspec due to conflict");
        }
        ...
        if (readmeStream != null)
        {
            ...
            if (result == StoragePutResult.Conflict)
            {
                ...
                throw new InvalidOperationException(
                    $"Failed to store package {lowercasedId} {lowercasedNormalizedVersion} readme due to conflict");
            }
        }
        ...
        if (iconStream != null)
        {
            ...
            if (result == StoragePutResult.Conflict)
            {
                ...
                throw new InvalidOperationException(
                    $"Failed to store package {lowercasedId} {lowercasedNormalizedVersion} icon");
            }
        }
    ...
    public async Task<Stream> GetPackageStreamAsync(string id, NuGetVersion version,
