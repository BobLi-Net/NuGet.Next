...
namespace NuGet.Next.Core.Extensions
{
    using NuGetPackageType = Packaging.Core.PackageType;
    ...
    public static class PackageArchiveReaderExtensions
    {
        ...
        private static List<NuGet.Next.Core.PackageType> GetPackageTypes(NuspecReader nuspec)
        {
            var packageTypes = nuspec
                .GetPackageTypes()
                .Select(t => new NuGet.Next.Core.PackageType
                {
                    Name = t.Name,
            ...
            {
                packageTypes.Add(new NuGet.Next.Core.PackageType
                {
