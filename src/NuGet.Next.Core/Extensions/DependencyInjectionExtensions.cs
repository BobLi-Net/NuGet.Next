...
namespace NuGet.Next.Core
{
    public static partial class DependencyInjectionExtensions
    {
        ...
        {
            services.AddBaGetOptions<NuGetNextOptions>();
            services.AddBaGetOptions<DatabaseOptions>(nameof(NuGetNextOptions.Database));
            services.AddBaGetOptions<FileSystemStorageOptions>(nameof(NuGetNextOptions.Storage));
            services.AddBaGetOptions<MirrorOptions>(nameof(NuGetNextOptions.Mirror));
            services.AddBaGetOptions<SearchOptions>(nameof(NuGetNextOptions.Search));
            services.AddBaGetOptions<StorageOptions>(nameof(NuGetNextOptions.Storage));
        }
