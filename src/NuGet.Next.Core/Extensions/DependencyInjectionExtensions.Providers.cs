...
namespace NuGet.Next.Core
{
    ...
    {
        private static readonly string DatabaseTypeKey = $"{nameof(NuGetNextOptions.Database)}:{nameof(DatabaseOptions.Type)}";
        private static readonly string SearchTypeKey = $"{nameof(NuGetNextOptions.Search)}:{nameof(SearchOptions.Type)}";
        private static readonly string StorageTypeKey = $"{nameof(NuGetNextOptions.Storage)}:{nameof(StorageOptions.Type)}";
