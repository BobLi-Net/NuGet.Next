...
export const Search = (q?: string | null, skip: number = 0, take: number = 20, prerelease?: boolean | null, semVerLevel?: string | null, packageType?: string | null, framework?: string | null) => {
...
export const Autocomplete = (q?: string, id?: string, skip: number = 0, take: number = 20, prerelease?: boolean, semVerLevel?: string, packageType?: string) => {
    const query = new URLSearchParams()
    if (q) query.append('q', q);
