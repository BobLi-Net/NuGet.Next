...
const AdminWelcome: React.FC = () => {
    ...
    return (
        <Content style={{ padding: '50px' }}>
            <div className="site-layout-content" style={{ padding: '24px', borderRadius: '8px', boxShadow: '0 2px 8px rgba(0,0,0,0.15)' }}>
                <Title level={3} style={{ marginBottom: '24px' }}>欢迎来到管理中心</Title>
